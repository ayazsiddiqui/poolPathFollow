...
%           Don't worry if the value is greater than 2*pi, it'll still 
...
% test if this single line of code can eliminate all of the above
...
sTest = eq_newtFunc(e,a,b,sPrev,ux,uy,uz);
